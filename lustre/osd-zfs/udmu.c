...
int udmu_blk_insert_cost(struct osd_device *osd)
{
...
int udmu_objset_statfs(struct osd_device *osd, struct obd_statfs *osfs)
{
 ...
 */
uint64_t udmu_objset_user_iused(struct osd_device *osd, uint64_t uidbytes)
{
	udmu_objset_t *uos = osd->od_objset;
	uint64_t refdbytes, availbytes, usedobjs, availobjs;
